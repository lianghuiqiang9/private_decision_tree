(base) ubuntu220402@ubuntu220402:~/Workspace/PDTE_rust_demo_6_advance_ciphertree$ cargo build --release
   Compiling homdte v0.1.0 (/home/ubuntu220402/Workspace/PDTE_rust_demo_6_advance_ciphertree)
    Finished release [optimized] target(s) in 11.89s
warning: the following packages contain code that will be rejected by a future version of Rust: fs_extra v1.2.0
note: to see what the problems were, use the option `--future-incompat-report`, or run `cargo report future-incompatibilities --id 1`
(base) ubuntu220402@ubuntu220402:~/Workspace/PDTE_rust_demo_6_advance_ciphertree$ cargo run --release
   Compiling homdte v0.1.0 (/home/ubuntu220402/Workspace/PDTE_rust_demo_6_advance_ciphertree)
...
WARNING: You are currently using the software variant of concrete-csprng which does not have access to a hardware source of randomness. To ensure the security of your application, please arrange to provide a secret by using the `concrete_csprng::set_soft_rdseed_secret` function.
WARNING: You are currently using the software variant of concrete-csprng which does not have access to a hardware source of randomness. To ensure the security of your application, please arrange to provide a secret by using the `concrete_csprng::set_soft_rdseed_secret` function.
服务器生成默认参数sk, RGSW(-s), ksk_map的时间: 2.213294719s
        ...
        right:Internal: index: 0 op: LEQ
                left:Internal: index: 0 op: LEQ
                        ...
                        right:Internal: index: 0 op: LEQ
                                ...
                                right:  Leaf: 0
                right:  Leaf: 0
服务器对决策树进行加密并打印加密决策树部分数据的时间为: 48.813954033s
******************************* step 1: server end *******************************
******************************* step 2: client begin *******************************
客户端生成默认参数
WARNING: You are currently using the software variant of concrete-csprng which does not have access to a hardware source of randomness. To ensure the security of your application, please arrange to provide a secret by using the `concrete_csprng::set_soft_rdseed_secret` function.
...
进入到server_f中
进入到server_f中
客户端评估 40 行数据, 完成 step 2 的时间为 36.04624046s 
客户端向服务器发送比较结果的密文
*******************************step 2: client end*******************************
*******************************step 3: server begin *******************************
服务器接收到比较结果的密文
